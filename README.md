**_Hotel Revenue & Booking Analysis_**
...
Checked for consistency across dimensions and fact tables

3️⃣ **Executive Summary**

The analysis evaluates hotel performance across revenue, occupancy, bookings, and cancellations to identify key drivers and optimization opportunities.

**Revenue**: Concentrated in a few cities and premium hotels → prioritize marketing & resources

**Occupancy**: Premium rooms highly occupied; Standard/Elite rooms underutilized → promotions & dynamic pricing needed

**Booking Trends**: Weekend bookings dominate; week-over-week fluctuations suggest staffing & inventory adjustments

**Cancellations**: Higher on weekdays and lower-tier rooms → policy improvements needed

**Platform Insights**: Others drive most revenue but show higher cancellations → platform-specific retention strategies
...
**Property-wise**: Top 3 hotels **(Atliq Palace, AtliQ exotica, Alitq City)** contribute **~50%** revenue → monitor underperformers
...
3. **Booking & Cancellation Trends**

**Booking %**: Majority bookings in top cities & hotels → focus retention strategies
